      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-foreground-secondary text-lg max-w-2xl mx-auto">
            Recognition for excellence in various competitions and academic
            projects
          </p>
        </div>
              ...
              >
                <div className="flex flex-col md:flex-row md:items-center justify-between">
                  <div className="flex items-start md:items-center space-x-4 mb-4 md:mb-0">
                    <div
                      className={`p-3 rounded-full border-2 ${getRankColor(
                        achievement.rank
                      )}`}
                    >
                    ...
                    <div className="flex-1">
                      <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-4 mb-2">
                        ...
                        <span
                          className={`inline-block px-3 py-1 rounded-full text-sm font-semibold ${getRankColor(
                            achievement.rank
                          )} border-0`}
                        >
