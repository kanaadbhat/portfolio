    ...
    <div className="container mx-auto px-6">
      ...
      <div className="grid gap-8 md:grid-cols-3">
        {education.map((edu, idx) => (
          <div
            key={idx}
            className="glass-card rounded-2xl p-6 flex flex-col h-full border border-card-border shadow-md"
          >
            <h3 className="text-xl font-bold text-primary mb-2">
              {edu.degree || edu.qualification}
            </h3>
            <div className="text-foreground-secondary mb-1 font-semibold">
              {edu.institution}
            </div>
