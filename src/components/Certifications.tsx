      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-foreground-secondary text-lg max-w-2xl mx-auto">
            Continuous learning through professional certifications and
            specialized courses
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
            ...
            {certifications.map((cert, index) => (
              ...
              >
                <div className="flex items-start space-x-4">
                  <div
                    className={`p-3 rounded-xl ${cert.bgColor} border ${cert.borderColor}`}
                  >
          ...
          <div className="text-center mt-16 mb-8">
            ...
            <p className="text-foreground-secondary text-lg max-w-xl mx-auto mb-6">
              All my digital badges and certifications are verifiable on Credly.
              Click below to view my full profile.
            </p>
            <a
          ...
          <div className="mt-16">
            {" "}
            {/* Adjust mt-16 if it's too much space after the new Credly section */}
            <div className="glass-card rounded-2xl p-8 text-center">
              ...
              <p className="text-foreground-secondary leading-relaxed max-w-2xl mx-auto mb-6">
                ...
                continuously expanding my skill set. These certifications
                represent my dedication to professional growth and mastery of
